...
export default function Stuffs() {
  return (
    <section className="relative h-auto w-full md:max-w-xl lg:min-w-1/6 rounded-bl-none rounded-t-xl rounded-tl-xl p-4 -mt-16 overflow-hidden">
      <div className="w-auto h-6 absolute top-0 left-4 px-2 bg-[#252525] rounded-[2px] flex flex-wrap font-semibold items-center text-[10px] sm:text-[10px] md:text-[10px] font-light text-gray-600">
