...
export default function DrawingBoard({ toggleDrawingBoard }) {
    ...
    return (
        <section
            ref={containerRef}
            className=" w-full z-10000 max-w-sm md:max-w-md lg:min-w-1/6 rounded-xl absolute top-1/2 left-1/2 transform -translate-1/2 p-0 mx-auto bg-[#252525] border border-[#1B1B1B] shadow-2xl"
        >
